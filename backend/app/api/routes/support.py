...
# ── IMPORTANT: Admin static routes MUST be registered BEFORE /{ticket_id}
#    Otherwise FastAPI treats "admin" as an integer ticket_id → 422 error
...
# ── User: Get single ticket — MUST be last (catches /{ticket_id}) ──────
